...
namespace ProiectMPD.Data.Migrations
{
    ...
    [Migration("20240102141000_LibraryRenameToMusicLibrary")]
    partial class LibraryRenameToMusicLibrary
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MusicLibraryRelease", b =>
                {
                    b.Property<int>("MusicLibrariesID")
                        .HasColumnType("int");

                    b.Property<int>("ReleasesID")
                        .HasColumnType("int");

                    b.HasKey("MusicLibrariesID", "ReleasesID");

                    b.HasIndex("ReleasesID");

                    b.ToTable("MusicLibraryRelease");
                });
            ...
            modelBuilder.Entity("ProiectMPD.Models.MusicLibrary", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProiectMPD.Models.Review", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProiectMPD.Models.Song", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GenreRelease", b =>
                {
                    b.HasOne("ProiectMPD.Models.Genre", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MusicLibraryRelease", b =>
                {
                    b.HasOne("ProiectMPD.Models.MusicLibrary", null)
                        .WithMany()
                        .HasForeignKey("MusicLibrariesID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
